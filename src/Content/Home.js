...
import image01 from "../Images/casa01.png"


export default function Home() {
  return( 
      <section className="flex items-center snap-start justify-between lg:max-w-7xl lg:mx-auto max-w-full px-[8%] flex-wrap w-full lg:py-36 py-[20%] h-screen font-display" id="Home">
        ...
        <div className="col-start-2 invisible">
          <img src={image01} className="justify-self-end md:relative md:inset-0  md:border-2 md:shadow-md md:visible max-w-lg rounded" alt="logo" />
        </div>
      </section>
  )
}